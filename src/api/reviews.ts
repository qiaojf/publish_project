...
export const approveReview = (id: number, comment?: string): Promise<ContentItem> => useMock ? mockDb.approve(id, comment) : request.post<ContentItem>(`/reviews/${id}/approve`, { comment }, { timeout: 11 * 60 * 1000 }).then(unwrap)
