...
function initialDatabase(): Database {
  return {
    ...
    targets: [
      ...
      { id: 3, name: '文档中心', target_type: 'local', content_types: ['pdf', 'word', 'excel'], config: {}, publish_root: '/var/www/company/docs/', base_url: 'https://internal.example.com/docs/', enabled: true, created_at: ago(24 * 65) },
      { id: 4, name: '公共文件', target_type: 'local', content_types: ['image', 'file'], config: {}, publish_root: '/data/company/assets/', base_url: 'https://internal.example.com/assets/', enabled: true, created_at: ago(24 * 40) }
    ],
    contents: [
