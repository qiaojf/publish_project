...
def test_metadata_contains_exactly_eight_postgresql_tables() -> None:
    assert set(Base.metadata.tables) == {
        "users", "departments", "categories", "contents", "publish_targets", "review_records", "publish_records", "operation_logs",
    }
