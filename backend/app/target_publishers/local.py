...
from app.utils.paths import build_file_url, build_view_url, resolve_publish_root, safe_child
    ...
    def publish(self, artifact: PublishArtifact, target: PublishTarget) -> TargetPublishResult:
        ...
        try:
            ...
            if artifact.is_directory:
                ...
                publish_url = build_file_url(target.base_url, artifact.local_path.name)
